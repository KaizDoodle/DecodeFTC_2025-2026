...
public class AutoClosePath18 {
    ...
    public AutoClosePath18(Follower follower, Alliance alliance) {
    ...
    public PathChain shootPreloadIntoPickUp1() {
    ...
    public PathChain next() {
        switch (index++) {
            case 0: return shootPreloadIntoPickUp1();
            case 1: return score1();
            case 2: return pickUpGate();
            case 3: return scoreGate();
            case 4: return pickUpGate();
            case 5: return scoreGate();
            case 6: return pickUp2();
            case 7: return score2();
            case 8: return pickUp3();
            case 9: return score3();
            case 10: return outOfBox();
            default: return null;
        }
    }
